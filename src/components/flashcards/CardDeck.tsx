      ...
      {done ? (
        <div className="text-center py-12">
          ...
          <p className="text-gray-500">
            You reviewed all {cards.length} cards. Cards you marked &quot;Again&quot; are saved to your{' '}
            <a href="/flashcards/again" className="text-blue-600 underline hover:text-blue-700">Again list</a>.
          </p>
        </div>
      ) : (
